...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (thinking/omc-plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (thinking/omc-notepads/{plan-name}/) after completing work.
