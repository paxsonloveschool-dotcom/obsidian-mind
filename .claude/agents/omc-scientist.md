...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `thinking/omc-scientist/reports/` with visualizations in `thinking/omc-scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (thinking/omc-scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: thinking/omc-scientist/reports/{timestamp}_report.md
  </Output_Format>
